...
The Depreciation Clock angle. Bold, factual, creates urgency through truth rather than manufactured pressure. May polarize but will stand out.

### C: "One more step before your first listing"
Task-oriented, progress-focused. Sellers who are motivated to list will open to find out what is standing between them and going live.
...
Sent the morning after signup. B2B flooring professionals check email early. Tuesday-Thursday mornings are peak engagement windows. If signup was on a Friday, this lands Monday morning.

---

## Email Copy

Your business is verified. Next step: connect your Stripe account so you can get paid.
...
Setup takes about 3 minutes. Once connected, you are ready to create your first listing.

The math on waiting: the average distributor's carrying cost runs ~20% of inventory value per year. On a $200K surplus position, that is $40K annually in warehouse space, insurance, handling, and depreciation -- roughly $110 per day.

Every day that inventory sits, your recovery margin shrinks.

---

**P.S.** Already have a Stripe account? Even faster. PlankMarket connects to your existing account -- no new setup required.
