---
title: 'When to Liquidate vs. When to Hold: A Distributor''s Framework'
slug: when-to-liquidate-vs-hold-framework
target_keyword: liquidate flooring timing
secondary_keywords: >-
  when to sell surplus flooring, inventory liquidation timing, flooring
  inventory decision
...
After 6 months: $21,000 in holding costs.
After 12 months: $42,000 in holding costs.
...
$75,000 - $70,000 = $5,000 gain from waiting
$21,000 = cost of waiting
...
1. **Audit your surplus.** List everything that isn't selling through normal channels.

2. **Calculate holding costs.** Per item or per category. Be honest about depreciation.

3. **Assign probabilities.** What's the realistic chance each item sells internally?

4. **Apply the framework.** For each item: hold (with active effort) or liquidate?

5. **Set deadlines.** For "hold" items, set a date when they automatically move to liquidation if not sold.

6. **Execute liquidation.** List on marketplaces, contact closeout buyers, price to move.
...
*PlankMarket helps distributors liquidate surplus flooring to verified buyers. [See how it works →](/how-it-works)*
